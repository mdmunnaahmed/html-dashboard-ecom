class Common {
	...
	_initTooltips() {
		[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function (e) {
			return new bootstrap.Tooltip(e, { delay: { show: 1e3, hide: 0 } });
		}),
			[].slice.call(document.querySelectorAll('.no-delay[data-bs-toggle="tooltip"][data-bs-delay="0"]')).map(function (e) {
				return new bootstrap.Tooltip(e, { delay: { show: 0, hide: 0 } });
			});
	}
	_initPopovers() {
	...
	_initScrolls() {
		if ("undefined" != typeof OverlayScrollbars) {
			OverlayScrollbars(document.querySelectorAll(".scroll"), { scrollbars: { autoHide: "leave", autoHideDelay: 600 }, overflowBehavior: { x: "hidden", y: "scroll" } }),
				OverlayScrollbars(document.querySelectorAll(".scroll-horizontal"), { scrollbars: { autoHide: "leave", autoHideDelay: 600 }, overflowBehavior: { x: "scroll", y: "hidden" } }),
				OverlayScrollbars(document.querySelectorAll(".data-table-rows .table-container"), { overflowBehavior: { x: "scroll", y: "hidden" } }),
				OverlayScrollbars(document.querySelectorAll(".scroll-track-visible"), { overflowBehavior: { x: "hidden", y: "scroll" } }),
				OverlayScrollbars(document.querySelectorAll(".scroll-horizontal-track-visible"), { overflowBehavior: { x: "scroll", y: "hidden" } }),
	...
	_initDropdownAsSelect() {
		document.querySelectorAll(".dropdown-as-select .dropdown-menu a").forEach((e) => {
			e.addEventListener("click", (e) => {
				...
				let a = "";
				n.getAttribute("data-childSelector") && (a = " " + n.getAttribute("data-childSelector")),
					(n.querySelector('[data-bs-toggle="dropdown"]' + a).innerHTML = o),
	...
	_initModalPadding() {
		...
		const e = document.getElementById("paddingModal"),
			t = new bootstrap.Modal(e, { backdrop: !1 });
	...
	_setDatePickerDefaults() {
		jQuery().datepicker && (jQuery.fn.datepicker.defaults.templates = { leftArrow: '<i class="cs-chevron-left"></i>', rightArrow: '<i class="cs-chevron-right"></i>' });
	}
	_setNotifyDefaults() {
